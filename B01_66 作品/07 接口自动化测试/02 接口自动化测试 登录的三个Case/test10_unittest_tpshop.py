...
class TPShopLogin(unittest.TestCase):
    ...
    def test01_success(self):
        self.rd = {"username": "13088888888", "password": "123456", "verify_code": "8888"}
        # 发送验证码请求并断言
        ...
        self.assertIn('验证码错误', r.json().get('msg'))
    ...
    def test02_user_is_not_exist(self):
        ...
        # 发登录请求并断言
        self.r2d = {"username": "13488888889", "password": "123456", "verify_code": "8888"}
        r2 = self.session.post(url=self.url_verify, data=self.r2d)
        # print(r2.json())
        self.assertEqual(200, r2.status_code)
        self.assertIn('账户不存在', r2.json().get('msg'))
